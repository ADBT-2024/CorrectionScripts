  ...
  up: async (queryInterface, Sequelize) => {
    ...
    */
    ...
    await queryInterface.bulkInsert('Restaurants',
      [
        { name: 'Mañana restaurant', description: 'Traditional cuisine', address: 'Kurkowa 1, 31-504 Kraków, Poland', postalCode: '123-4567', url: 'https://goo.gl/maps/GZEfzge4zXz6ySLR8', restaurantCategoryId: 1, shippingCosts: 2.5, email: 'mañana@restaurant.com', heroImage: 'public/restaurants/mañanaRestaurantHero.jpeg', logo: 'public/restaurants/mañanaRestaurantLogo.png', phone: 954123123, createdAt: new Date(), updatedAt: new Date(), userId: 2, status: 'closed' },
